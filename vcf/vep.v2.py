...
def group_gene_ps(hap1_results, hap2_results):
        ...
        for ps, variants1 in ps_dict.items():
            ...
            if ps == 'hom_alt':
                if any(vep[2] == 'HIGH' for vep in variants1):
                    ...
                    print(f'hom_alt Gene: {gene}, PS: {ps}, Variants: {v_lof}')
            else:
                if any(vep[2] == 'HIGH' for vep in variants1) and any(vep[2] == 'HIGH' for vep in variants2):
                    ...
                    print(f'het_alt Gene: {gene}, PS: {ps}, Variants: {v1}, {v2}')
...
if __name__ == "__main__":
    ...
    hap1_results, hap2_results = analyze_haplotypes('../data/high.vcf.gz', chrom, start, end)
    group_gene_ps(hap1_results, hap2_results)